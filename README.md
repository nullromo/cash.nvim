...
```lua
{
    ...
    indicator = {
        ...
        -- number
        pattern = false,
        -- how much of the pattern is shown
        patternWidth = 20,
...
| `indicator.pattern`                                             | boolean                                        | `false`                                                           | Whether or not the indicator shows the working cash register's pattern as well as its number.                                                                                                                                                                                                                                                                                                                  |
| `indicator.patternWidth`                                        | number                                         | `20`                                                              | How much of the pattern is shown in the indicator before being truncated with `~`.                                                                                                                                                                                                                                                                                                                             |
